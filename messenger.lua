...
keyhere.PlaceholderText = "Enter Key Here..."
keyhere.Text = ""
...
TextLabel.Text = "Gringo Hub | Key System"
...
setclipboard("Link GetKey Ở Đây")
            DiscordLib:Notification("Key System" , "Copied, please open Browser or Chome to get it and come back here." , 3)
end)
...
confirm.Text = "Check Key"
confirm.TextColor3 = Color3.fromRGB(255, 255, 255)
confirm.TextSize = 14.000
confirm.MouseButton1Click:Connect(function()
DiscordLib:Notification("Key System" , "Key Error Bro..." , 3)
if keyhere.Text == "Key Ở Đây" then
wait(3)
ZENHUB:Destroy()
game:GetService("CoreGui").Orion:Destroy()
else
DiscordLib:Notification("Key System" , "Success Key, Loading Script..." , 3)
end
end)
